...
class AdvancedScene(Scene):
    ...
    def construct(self) -> None:
        ...
        circle.scale(10.0)
        circle.move_to([1.06, 1.95, 0.0])
        self.play(GrowFromCenter(circle), run_time=0.8)
        square = Square(side_length=2.7, color=BLUE, fill_opacity=0.4, stroke_opacity=1.0, stroke_width=20.0)
        square.scale(0.1)
        square.move_to([4.97, 1.58, 0.0])
        ...
        triangle.scale(7.0)
        triangle.move_to([-5.35, 2.15, 0.0])
